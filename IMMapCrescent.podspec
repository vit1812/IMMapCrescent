...
Pod::Spec.new do |s|
    s.name             = 'IMMapCrescent'
    s.version          = '1.0'
    s.summary          = 'Indoor map framework'
    s.homepage         = 'https://github.com/vit1812/IMMapCrescent'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'Luong Vinh' => 'ltvinh1812@gmail.com' }
    s.source           = { :git => 'https://github.com/vit1812/IMMapCrescent.git', :tag => s.version.to_s }
    s.swift_version    = '5.0'
    s.ios.deployment_target = '10.0'
    s.vendored_frameworks = 'IMMapCrescent/Frameworks/*'
